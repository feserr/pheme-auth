...
func Register(c *fiber.Ctx) error {
	...
	if createdUser := database.DB.Create(&user); createdUser.Error != nil {
		c.Status(fiber.StatusBadRequest)
		return c.JSON(fiber.Map{
...
func Login(c *fiber.Ctx) error {
	...
	user := models.User{}
	if loggedUser := database.DB.Where("email = ?", body.Email).First(&user); loggedUser.Error != nil {
